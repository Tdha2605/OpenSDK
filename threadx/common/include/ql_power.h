...
enum{
    QL_SLEEP_FLAGS_SUCCESS  =  0x00,
    QL_SLEEP_FLAGS_ERROR      ,      
    QL_SLEEP_FLAGS_INVALID    ,   
};
...
/***********************************************************************
 *
 * Name:   ql_enable_uart_rx_wakeup_reg   
 *
 * Description: enable/disable  Main uart rx wakeup function
 *
 * Parameters:	enable: 0：disable ; 1：enable 
 *		   
 * Returns:   				
 ***********************************************************************/
void ql_enable_uart_rx_wakeup_reg(unsigned char enable);
