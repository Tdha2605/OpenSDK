...
typedef struct
{
	...
	char max_num;	// max number of concatenated short messages  
	char cur_num;   // current number of concatenated short messages
	UINT16 reference_num; // Reference Number for concatenated short messages
}QL_SMS_STATUS_INFO;
