...
static void ql_http_client_test(void *arg)
{
	...
	SSLConfig sslConfig = 
	{
		...
		//.serverName = "us1.unwiredlabs.com",
	...
	while (client&&(run_num<5)) 
	{
		...
		//	{
			...
			//}
			//ret=ql_http_client_request(client, "https://210.245.54.60:1443/tracking/internal/status", QL_HTTP_CLIENT_REQUEST_POST,QL_HTTP_CLIENT_AUTH_TYPE_NONE,NULL,NULL,json_string,strlen(json_string),response_cb,NULL);
