...
typedef void (* _api_quec_at_srv_set_app_shell_cmds_t)(utlAtCommand_T *shell_cmds,int num);
...
static _api_quec_at_srv_set_app_shell_cmds_t m_quec_at_srv_set_app_shell_cmds = NULL;
