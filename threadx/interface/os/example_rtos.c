...
#define KEYMSGSIZE  1 /*������ÿ����Ϣ�Ĵ�С,��λ�ֽ�*/
...
//@20221201 task6��task7��֤��ʱ���Ƚӿ����ã���ʵ��ʹ�ù�����Ӧ���������ѭ�����Է�ֹϵͳ�ں�IDLE����ʼ���޷�����
//�����޷��������� �����ô˽ӿڴ�����task���ȼ���ֵ�ϴ���100��
void quec_task_create_ex_test(void)
{
	QlOSStatus ret = 0;
	printf("task_create_ex test start");
    ret = ql_rtos_task_create_ex(&taskRef6, 1024, 101,"task6", task6, NULL, 0);
    if(ret != 0)
    {
		printf("-----task6 create fail!-----\r\n");
	}
    ret = ql_rtos_task_create_ex(&taskRef7, 1024, 101,"task7", task7, NULL, 0);
    if(ret != 0)
    {
		printf("-----task7 create fail!-----\r\n");
	}
}

application_init(task_test_init, "task_test_mempool_size", 10, 0);
application_init(quec_task_create_ex_test, "quec_task_create_ex_test", 10, 0);
