...
//	ql_rtos_task_sleep_s(5);
...
#if 0 //EC800M xxxx
	QL_KPAD_MKOUT_E row[QL_KEYPAD_MATRIX_LENGTH]= {QL_KP_OUT2,QL_KP_OUT0, QL_KP_OUT7, QL_KP_OUT4, QL_KP_OUT5,QL_KP_OUT_NO_VALID,
		                                           QL_KP_OUT_NO_VALID,QL_KP_OUT_NO_VALID};
	QL_KPAD_MKIN_E col[QL_KEYPAD_MATRIX_LENGTH] ={QL_KP_IN2,QL_KP_IN0, QL_KP_IN7, QL_KP_IN4,QL_KP_IN5,QL_KP_IN_NO_VALID, QL_KP_IN_NO_VALID,
		                                          QL_KP_IN_NO_VALID};
#else //EC600M xxxx
	QL_KPAD_MKOUT_E row[QL_KEYPAD_MATRIX_LENGTH]= {QL_KP_OUT2,QL_KP_OUT0, QL_KP_OUT3, QL_KP_OUT4, QL_KP_OUT5,QL_KP_OUT_NO_VALID,
		                                           QL_KP_OUT_NO_VALID,QL_KP_OUT_NO_VALID};
	QL_KPAD_MKIN_E col[QL_KEYPAD_MATRIX_LENGTH] ={QL_KP_IN1,QL_KP_IN0, QL_KP_IN3, QL_KP_IN2,QL_KP_IN5,QL_KP_IN_NO_VALID, QL_KP_IN_NO_VALID,
		                                          QL_KP_IN_NO_VALID};
#endif
	...
	printf("DBG===R03_b04=FF==keypad_test \r\n");
